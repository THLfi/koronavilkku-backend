...
insert into en.exposure_configuration
  (minimum_risk_score, attenuation_scores, days_since_last_exposure_scores, duration_scores, transmission_risk_scores, duration_at_attenuation_thresholds, duration_at_attenuation_weights, exposure_risk_duration)
select * from (
    values
      (72::int,
